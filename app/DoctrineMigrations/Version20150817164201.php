 ...
 */
class Version20150817164201 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE content_block (id INT AUTO_INCREMENT NOT NULL, media INT DEFAULT NULL, locked TINYINT(1) NOT NULL, hidden TINYINT(1) NOT NULL, layoutType INT NOT NULL, title VARCHAR(255) NOT NULL, body LONGTEXT NOT NULL, sortOrder INT NOT NULL, doubleWidth TINYINT(1) NOT NULL, INDEX IDX_68D8C3F06A2CA10C (media), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
