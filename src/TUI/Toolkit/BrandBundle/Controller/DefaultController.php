...
class DefaultController extends Controller
{
    ...
    public function colorsErrorAction()
    {
      ...
      return $this->render('BrandBundle:Default:colors-error.html.twig', array('brand' => $brand));
    }

    public function colorsPdfAction()
    {
      $em = $this->getDoctrine()->getManager();
      // Get the default/hardcoded Brand
      $default_brand = $em->getRepository('BrandBundle:Brand')->findOneByName('ToolkitDefaultBrand');
      ...
      return $this->render('BrandBundle:Default:colors-pdf.html.twig', array('brand' => $brand));
    }
    ...
    public function footerAction()
    {
      ...
      return $this->render('BrandBundle:Default:footer.html.twig', array('brand' => $brand));
    }
}
