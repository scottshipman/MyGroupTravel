...
class TourSiteController extends Controller
{
     ...
     *
     * @param null $id
     * @param null $quoteNumber
     * @param null $slug
     * @return Response
     */
    public function siteShowAction($id = null, $quoteNumber = null, $slug = null)
    {
        $alternate = false;
        $editable = false;
        $permission = array();
        ...
        if (empty($id) && !empty($slug)) {
            $entity = $em->getRepository('TourBundle:Tour')->findOneBy(array('slug' => $slug));
