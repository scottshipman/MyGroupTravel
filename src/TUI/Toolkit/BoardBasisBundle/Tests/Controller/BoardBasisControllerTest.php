...
namespace TUI\Toolkit\BoardBasisBundle\Tests\Controller;
...
class BoardBasisControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'tui_toolkit_boardbasisbundle_boardbasis[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Update')->form(array(
            'tui_toolkit_boardbasisbundle_boardbasis[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
